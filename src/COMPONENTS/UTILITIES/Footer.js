  ...
  return (
    <footer className=' bg1 color2 font1'>
      ...
      <div className='footer-links'>
        ...
        <Link className='footer-link color2' to="/locations">Locations</Link>
        <Link className='footer-link color2' to="/team">Team</Link>
        <Link className='footer-link color2' to="/services">Services</Link>
        <Link className='footer-link color2' to="/contact">Contact Us</Link>
      </div>
